...
- Base URL: https://47aab6d35923a7.lhr.life
- Health: https://47aab6d35923a7.lhr.life/health
- OpenAPI: https://47aab6d35923a7.lhr.life/openapi.json
- Discovery: https://47aab6d35923a7.lhr.life/.well-known/apk-intel.json
...
curl -H "X-SOLANA-TRANSACTION: SIGNATURE" \\
  ...
  --data-binary "@app.apk" \\
  https://47aab6d35923a7.lhr.life/v1/apk/quick
```
